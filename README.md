...
| --- | --- | --- |
| **Executes onchain via KeeperHub** | Every revocation is a real `execute_contract_call` signed by the org's KeeperHub-managed Turnkey wallet, gas-sponsored. Revoke verified on-chain afterwards (`allowance == 0` read via independent RPC). | Revoke tx [`0x1e4c…912f`](https://sepolia.etherscan.io/tx/0x1e4c1b81592ffbe70ba9be8c0d427e4f6ab3b511b03e2a6dad4381dd5698912f); end-to-end harness revoke tx [`0x42ba…4a4c`](https://sepolia.etherscan.io/tx/0x42ba20119f8a039691cfe2a3f0e56f31a119e3c97faefa788c8be1632bdf9a4c) |
...
| 5 | **End-to-end harness revoke** (scan → confirm → revoke → verify) | [`i8q7efwybk9natj0eed8b`](https://app.keeperhub.com/executions/i8q7efwybk9natj0eed8b) | [`0x42ba…4a4c`](https://sepolia.etherscan.io/tx/0x42ba20119f8a039691cfe2a3f0e56f31a119e3c97faefa788c8be1632bdf9a4c) |
